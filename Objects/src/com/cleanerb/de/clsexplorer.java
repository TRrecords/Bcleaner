...
public class clsexplorer extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "com.cleanerb.de.clsexplorer");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", com.cleanerb.de.clsexplorer.class).invoke(this, new Object[] {null});
        else
...
public com.cleanerb.de.clsexplorer._typresult _selection = null;
...
public com.cleanerb.de.clschecklist _lstfichiers = null;
...
_selection = new com.cleanerb.de.clsexplorer._typresult();
...
_lstfichiers = new com.cleanerb.de.clschecklist();
