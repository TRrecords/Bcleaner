...
public class clschecklist extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "com.cleanerb.de.clschecklist");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", com.cleanerb.de.clschecklist.class).invoke(this, new Object[] {null});
        else
...
int _i = 0;
com.cleanerb.de.clschecklist._typsortdata _sortdata = null;
int _firsttosort = 0;
int _lasttosort = 0;
...
_sortdata = new com.cleanerb.de.clschecklist._typsortdata();
...
_sortdata = (com.cleanerb.de.clschecklist._typsortdata)(_sortlist.Get((int) (_i-_firstposition)));
