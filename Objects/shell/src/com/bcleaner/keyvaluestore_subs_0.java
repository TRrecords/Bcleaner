...
try {
		Debug.PushSubsStack("Close (keyvaluestore) ","keyvaluestore",2,__ref.getField(false, "ba"),__ref,148);
...
try {
		Debug.PushSubsStack("complete (keyvaluestore) ","keyvaluestore",2,__ref.getField(false, "ba"),__ref,188);
...
try {
		Debug.PushSubsStack("ContainsKey (keyvaluestore) ","keyvaluestore",2,__ref.getField(false, "ba"),__ref,89);
...
try {
		Debug.PushSubsStack("CreateTable (keyvaluestore) ","keyvaluestore",2,__ref.getField(false, "ba"),__ref,179);
...
try {
		Debug.PushSubsStack("DeleteAll (keyvaluestore) ","keyvaluestore",2,__ref.getField(false, "ba"),__ref,95);
...
Debug.ShouldStop(1);
__ref.runClassMethod (com.bcleaner.keyvaluestore.class, "_createtable");
...
try {
		Debug.PushSubsStack("GetBitmap (keyvaluestore) ","keyvaluestore",2,__ref.getField(false, "ba"),__ref,123);
...
_c = __ref.runClassMethod (com.bcleaner.keyvaluestore.class, "_getcursor",(Object)(_key));Debug.locals.put("c", _c);Debug.locals.put("c", _c);
...
try {
		Debug.PushSubsStack("getCursor (keyvaluestore) ","keyvaluestore",2,__ref.getField(false, "ba"),__ref,170);
...
try {
		Debug.PushSubsStack("GetEncryptedObject (keyvaluestore) ","keyvaluestore",2,__ref.getField(false, "ba"),__ref,143);
...
if (true) return __ref.runClassMethod (com.bcleaner.keyvaluestore.class, "_getobjectinternal",(Object)(_key),(Object)(keyvaluestore.__c.getField(true,"True")),(Object)(_password));
...
try {
		Debug.PushSubsStack("GetInputStream (keyvaluestore) ","keyvaluestore",2,__ref.getField(false, "ba"),__ref,111);
...
try {
		Debug.PushSubsStack("GetObject (keyvaluestore) ","keyvaluestore",2,__ref.getField(false, "ba"),__ref,138);
...
Debug.ShouldStop(1024);
if (true) return __ref.runClassMethod (com.bcleaner.keyvaluestore.class, "_getobjectinternal",(Object)(_key),(Object)(keyvaluestore.__c.getField(true,"False")),(Object)(RemoteObject.createImmutable("")));
...
try {
		Debug.PushSubsStack("getObjectInternal (keyvaluestore) ","keyvaluestore",2,__ref.getField(false, "ba"),__ref,152);
...
try {
		Debug.PushSubsStack("GetSimple (keyvaluestore) ","keyvaluestore",2,__ref.getField(false, "ba"),__ref,101);
...
try {
		Debug.PushSubsStack("Initialize (keyvaluestore) ","keyvaluestore",2,__ref.getField(false, "ba"),__ref,8);
...
try {
		Debug.PushSubsStack("insertQuery (keyvaluestore) ","keyvaluestore",2,__ref.getField(false, "ba"),__ref,174);
...
try {
		Debug.PushSubsStack("ListKeys (keyvaluestore) ","keyvaluestore",2,__ref.getField(false, "ba"),__ref,77);
...
for (_row = 0 ; (step4 > 0 && _row <= limit4) || (step4 < 0 && _row >= limit4); _row = ((int)(0 + _row + step4)) ) {
...
try {
		Debug.PushSubsStack("PutBitmap (keyvaluestore) ","keyvaluestore",2,__ref.getField(false, "ba"),__ref,40);
...
Debug.ShouldStop(512);
__ref.runClassMethod (com.bcleaner.keyvaluestore.class, "_start",(Object)(_key));
...
Debug.ShouldStop(16384);
__ref.runClassMethod (com.bcleaner.keyvaluestore.class, "_insertquery",(Object)(_key),(Object)((_out.runMethod(false,"ToBytesArray"))));
 BA.debugLineNum = 48;BA.debugLine="out.Close";
Debug.ShouldStop(32768);
_out.runVoidMethod ("Close");
 BA.debugLineNum = 49;BA.debugLine="Return complete(True)";
Debug.ShouldStop(65536);
Debug.CheckDeviceExceptions();if (true) return __ref.runClassMethod (com.bcleaner.keyvaluestore.class, "_complete",(Object)(keyvaluestore.__c.getField(true,"True")));
...
Debug.ShouldStop(262144);
if (true) return __ref.runClassMethod (com.bcleaner.keyvaluestore.class, "_complete",(Object)(keyvaluestore.__c.getField(true,"False")));
 };
...
try {
		Debug.PushSubsStack("PutEncyptedObject (keyvaluestore) ","keyvaluestore",2,__ref.getField(false, "ba"),__ref,35);
...
Debug.ShouldStop(8);
if (true) return __ref.runClassMethod (com.bcleaner.keyvaluestore.class, "_putobjectinternal",(Object)(_key),(Object)(_value),(Object)(keyvaluestore.__c.getField(true,"True")),(Object)(_password));
...
try {
		Debug.PushSubsStack("PutInputStream (keyvaluestore) ","keyvaluestore",2,__ref.getField(false, "ba"),__ref,56);
...
try {
		Debug.PushSubsStack("PutObject (keyvaluestore) ","keyvaluestore",2,__ref.getField(false, "ba"),__ref,30);
...
Debug.ShouldStop(1073741824);
if (true) return __ref.runClassMethod (com.bcleaner.keyvaluestore.class, "_putobjectinternal",(Object)(_key),(Object)(_value),(Object)(keyvaluestore.__c.getField(true,"False")),(Object)(RemoteObject.createImmutable("")));
...
try {
		Debug.PushSubsStack("putObjectInternal (keyvaluestore) ","keyvaluestore",2,__ref.getField(false, "ba"),__ref,198);
...
Debug.ShouldStop(1048576);
__ref.runClassMethod (com.bcleaner.keyvaluestore.class, "_insertquery",(Object)(_key),(Object)((_buffer)));
...
Debug.CheckDeviceExceptions();if (true) return __ref.runClassMethod (com.bcleaner.keyvaluestore.class, "_complete",(Object)(keyvaluestore.__c.getField(true,"True")));
 Debug.CheckDeviceExceptions();
			...
			BA.rdebugUtils.runVoidMethod("setLastException",__ref.getField(false, "ba"), e18.toString()); BA.debugLineNum = 216;BA.debugLine="Return complete(False)";
Debug.ShouldStop(8388608);
if (true) return __ref.runClassMethod (com.bcleaner.keyvaluestore.class, "_complete",(Object)(keyvaluestore.__c.getField(true,"False")));
 };
...
try {
		Debug.PushSubsStack("PutSimple (keyvaluestore) ","keyvaluestore",2,__ref.getField(false, "ba"),__ref,16);
...
Debug.ShouldStop(262144);
__ref.runClassMethod (com.bcleaner.keyvaluestore.class, "_insertquery",(Object)(_key),(Object)(_value));
...
try {
		Debug.PushSubsStack("Remove (keyvaluestore) ","keyvaluestore",2,__ref.getField(false, "ba"),__ref,72);
...
try {
		Debug.PushSubsStack("start (keyvaluestore) ","keyvaluestore",2,__ref.getField(false, "ba"),__ref,183);
